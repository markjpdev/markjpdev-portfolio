...
import { ArrowRight, Mail, Folder, ShieldAlert, BookOpen, Terminal } from 'lucide-react'
      ...
      <div id="wrapper" className={visible ? 'is-article-visible' : ''}>
        ...
        <div id="main" onClick={close}>
          ...
          <article id="about" className={active === 'about' && !leaving ? 'active' : ''} onClick={e => e.stopPropagation()}>
            ...
            <p className="about-lead">
              Over a decade across technical operations, enterprise SaaS ecosystems, and integration compliance[cite: 4, 56, 57]. 
              Specializing in the stable execution layer where legacy infrastructure meets modern intelligent automation[cite: 4, 101].
            </p>
          ...
          <article id="contact" className={active === 'contact' && !leaving ? 'active' : ''} onClick={e => e.stopPropagation()}>
            ...
            <a className="contact-cta" href="mailto:markpunsalan@icloud.com">
              markpunsalan@icloud.com [cite: 2] <ArrowRight size={16} />
            </a>
        ...
        <footer id="footer">
          <p className="copyright">
            ...
            &nbsp;·&nbsp; <span className="dot-status" />currently optimizing backend automation & data workflows
          </p>
        </footer>
