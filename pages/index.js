...
export default function Home() {
  ...
  // Sync body data-section + has-active class
  useEffect(() => {
            ...
            <div className={`panel${active === 'writing' ? ' is-visible' : ''}`}>
              <ul className="writing-list">
                <li>
                  ...
                  <span className="title">On bridges and long arcs</span>
                  <span className="arrow">→</span>
                </li>
                <li>
                  <span className="date">2026.02</span>
                  <span className="title">What BPO actually teaches you about software</span>
                  <span className="arrow">→</span>
                </li>
                <li>
                  <span className="date">2025.11</span>
                  <span className="title">Automation as a craft, not a hustle</span>
                  <span className="arrow">→</span>
                </li>
                <li>
                  <span className="date">2025.09</span>
                  <span className="title">The slow path into deep tech</span>
                  <span className="arrow">→</span>
                </li>
              </ul>
            </div>
